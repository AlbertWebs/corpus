...
<html lang="en">
   <head>
      ...
      {{--  --}}
        <!-- Meta Tags -->
        <title>Corpus Investment Limited - Tailored Solutions for Growth and Legacy</title>
        ...
        <!-- Open Graph Tags -->
        <meta property="og:title" content="Corpus Investment Limited - Tailored Solutions for Growth and Legacy">
        ...
        <meta name="twitter:title" content="Corpus Investment Limited - Tailored Solutions for Growth and Legacy">
                  ...
                  <div class="col-lg-6">
                     <div class="about-header-area heading6">
                        ...
                        <p data-aos="fade-left" data-aos-duration="1000">
                           ...
                           legacy.<br><br> As a knowledgeable, approachable, and reliable partner, we focus
               ...
               <div class="row">
                  <div class="col-lg-12 m-auto">
                     <div class="service2-header heading2 text-center">
                        ...
                        <p data-aos="fade-up" data-aos-duration="1000">We pride ourselves on delivering a value proposition that goes beyond expectations. Our <br class="d-md-block d-none"> approach is centered on understanding your business</p>
                     </div>
                  </div>
               </div>
               <div class="row">
                        ...
                        <div class="row">
                           <div class="col-lg-12 col-md-6">
                              <div class="service2-auhtor-boxarea" data-aos="zoom-out" data-aos-duration="1000">
                                 ...
                                 <div class="content-area">
                                    <h5>Our Mission</h5>
                                    <a href="#">Empowering Enterprises with Trusted Financial Advisory Solutions </a>
                                    <p>
                                       To provide professional, reliable, and innovative financial advisory
                                       services to family businesses and other enterprises
                                    </p>
                                 </div>
                              </div>
                           </div>
                           <div class="col-lg-12 col-md-6">
                              <div class="service2-auhtor2-boxarea" data-aos="zoom-out" data-aos-duration="1200">
                                 ...
                                 <div class="content-area">
                                    <h5>Our Vision</h5>
                                    <a href="#">Leading the Way as East Africa's Trusted Advisor for Family Businesses</a>
                                    <p>
                                       To be the preferred financial advisory firm for family businesses
                                       across East Africa.
                                    </p>
                                 </div>
                              </div>
                  ...
                  <div class="col-lg-5" data-aos="zoom-out" data-aos-duration="1000">
                     <div class="contact-info-area">
                        ...
                        <div class="contact-auhtor-box">
                           <div class="icons">
                              <img src="{{asset('theme/assets/img/icons/location2.svg')}}" alt="">
                           </div>
                           <div class="content">
                              <h4>Our Location</h4>
                        ...
                        <div class="contact-auhtor-box">
                           <div class="icons">
                              <img src="{{asset('theme/assets/img/icons/phone2.svg')}}" alt="">
                           </div>
                           <div class="content">
                              <h4>Phone Number</h4>
                        ...
                        <div class="contact-auhtor-box">
                           <div class="icons">
                              <img src="{{asset('theme/assets/img/icons/email2.svg')}}" alt="">
                           </div>
                           <div class="content">
                              <h4>Email Address</h4>
                              <a href="mailto:info@corpusinvestmentsltd.com">info@corpusinvestmentsltd.com <br>
                                info@corpusinvestmentsltd.com</a>
                           </div>
                        </div>
                     </div>
                  </div>
