    ...
    <div class="container" style="margin:0 auto">
        <div class="row align-items-center" style="margin:0 auto">
            ...
            <div class="col-lg-8" style="margin:0 auto">
                {{--  --}}
                <p>At Corpus Investments Ltd ("we," "us," "our"), your privacy is of utmost importance. This Privacy Policy outlines how we collect, use, and protect your personal data when you interact with our website (<a href="https://www.corpusinvestmentsltd.com">https://www.corpusinvestmentsltd.com</a>) and our services. By using our website or services, you agree to the terms outlined in this policy.</p>

                <br><br><h3>1. Information We Collect</h3>
                <p>We may collect the following information when you interact with us:</p>
                <ul>
                    <li><strong>Personal Identification Information</strong>: Name, phone number, email address, and other contact details.</li>
                    <li><strong>Cookies and Tracking Data</strong>: Information about your device, browsing habits, and preferences.</li>
                    <li><strong>Other Voluntarily Provided Data</strong>: Any other information you provide when contacting us or using our services.</li>
                </ul>

                <br><br><h3>2. Use of Cookies</h3>
                ...
                <ul>
                    ...
                    <li>Personalize content and provide a better user experience.</li>
                </ul>
                <p>You can disable cookies in your browser settings; however, this may affect the functionality of our website.</p>

                <br><br><h3>3. How We Use Your Data</h3>
                <p>We collect and use your data for the following purposes:</p>
                <ul>
                    <li>To provide and improve our services.</li>
                    <li>To communicate with you about inquiries or services.</li>
                    <li>To comply with legal obligations.</li>
                    <li>To monitor and analyze website performance.</li>
                </ul>

                <br><br><h3>4. Confidentiality and Data Protection</h3>
                <p>We take the confidentiality of your data seriously and implement the following measures to ensure its protection:</p>
                <ul>
                    <li>Using secure servers and encryption to safeguard sensitive data.</li>
                    <li>Restricting access to your data to authorized personnel only.</li>
                    <li>Regularly reviewing our security practices to protect against unauthorized access or disclosure.</li>
                </ul>

                <br><br><h3>5. Sharing of Data</h3>
                <p>We do not sell or rent your personal data to third parties. We may share your data:</p>
                <ul>
                ...
                <p>To exercise these rights, please contact us at <a href="mailto:info@corpusinvestmentsltd.com">info@corpusinvestmentsltd.com</a> or call us at +254 (0) 796 357 344.</p>

                <br><br><h3>7. Data Retention</h3>
                <p>We retain your data only as long as necessary for the purposes outlined in this policy or as required by law.</p>

                <br><br><h3>8. Third-Party Websites</h3>
                <p>Our website may contain links to third-party websites. We are not responsible for the privacy practices or content of these sites. Please review their privacy policies before sharing your data.</p>

                <br><br><h3>9. Changes to This Privacy Policy</h3>
                <p>We may update this Privacy Policy from time to time. Any changes will be posted on this page with an updated effective date.</p>

                <br><br><h3>10. Contact Us</h3>
                <p>If you have questions or concerns about this Privacy Policy, please contact us:</p>
                <ul>
                    <li><strong>Email</strong>: <a href="mailto:info@corpusinvestmentsltd.com">info@corpusinvestmentsltd.com</a></li>
                    <li><strong>Phone</strong>: +254 (0) 796 357 344</li>
                    <li><strong>Location</strong>: Muthangari Rd, Nairobi, Kenya</li>
                </ul>

                <p>Thank you for trusting Corpus Investments Ltd with your information.</p>
